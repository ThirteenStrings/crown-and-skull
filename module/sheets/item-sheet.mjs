 ...
 * @extends {ItemSheetV2}
 */
export class CraskItemSheet extends api.HandlebarsApplicationMixin(
  sheets.ItemSheetV2
) {
  constructor(options = {}) {
    super(options);
  ...
  static PARTS = {
    header: {
      template: 'systems/crown-and-skull/templates/item/header.hbs',
    },
    tabs: {
    ...
    description: {
      template: 'systems/crown-and-skull/templates/item/description.hbs',
    },
    effects: {
      template: 'systems/crown-and-skull/templates/item/effects.hbs',
    },
  };
  ...
  async _prepareContext(options) {
    const context = {
      // Validates both permissions and compedium status
